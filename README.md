...
>
> This repository is a personal-use fork. It tracks upstream and keeps a small set of fork-specific patches.
>
> **Custom PRs merged from local git history:**
> - [#68](https://github.com/jwadow/kiro-gateway/pull/68) — `KIRO_CLI_API_REGION` override for kiro-cli API region (`a6f5ced`, merged by `50257b4`).
> - [#79](https://github.com/jwadow/kiro-gateway/pull/79) — Docker kiro-cli SQLite volume mount fix, removing read-only mode (`f7c6162`, merged by `3129d6d`).
> - [#80](https://github.com/jwadow/kiro-gateway/pull/80) — MongoDB API-key auth, credit billing, model allowlist, and Kiro usage-credit preservation (`470d807`, `adbf63c`, `234c58a`, merged by `0cdd564`).
> - [#82](https://github.com/jwadow/kiro-gateway/pull/82) — `claude-opus-4.6` fallback model plus unknown content-block sanitization (`979cdb2`, `1e9c067`, merged by `8885160`).
> - [#84](https://github.com/jwadow/kiro-gateway/pull/84) — close SQLite connections with `try/finally` (`a78cc44`, merged by `38df2fd`).
