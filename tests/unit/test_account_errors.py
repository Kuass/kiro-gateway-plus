...
class TestClassifyErrorRecoverable:
    ...
    def test_classify_error_400_invalid_model_id_recoverable(self):
        print("\n=== Test: 400 + INVALID_MODEL_ID → RECOVERABLE ===")

        result = classify_error(status_code=400, reason="INVALID_MODEL_ID")
